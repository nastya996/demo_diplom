...
public class ComparatorNotes implements Comparator<Note> {
    ...
    public int compare(Note o1, Note o2) {
        ...
        try {
            datedeadline1 = new SimpleDateFormat(context.getString(R.string.data)).parse(o1.getDateDeadline());
        ...
        try {
            datedeadline2 = new SimpleDateFormat(context.getString(R.string.data)).parse(o2.getDateDeadline());
        } catch (ParseException e) {
            e.printStackTrace();
        }

        try {
            dateUpdate1 = new SimpleDateFormat(context.getString(R.string.data)).parse(o1.getDateUpdateNote());
            dateUpdate2 = new SimpleDateFormat(context.getString(R.string.data)).parse(o2.getDateUpdateNote());
        } catch (ParseException e) {
            e.printStackTrace();
        }
